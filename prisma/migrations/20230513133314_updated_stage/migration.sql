/*
  ...
  - The values [Provisioning] on the enum `DeploymentStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "DeploymentStatus_new" AS ENUM ('Disabled', 'Starting', 'Building', 'Deploying', 'Running');
...
ALTER TABLE "Service" ALTER COLUMN "status" SET DEFAULT 'Disabled';
ALTER TABLE "Deployment" ALTER COLUMN "status" SET DEFAULT 'Starting';
COMMIT;

-- AlterTable
ALTER TABLE "Deployment" ALTER COLUMN "buildLogs" DROP NOT NULL,
ALTER COLUMN "deployLogs" DROP NOT NULL,
