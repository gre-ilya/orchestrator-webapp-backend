...
export class ServiceController {
  ...
  async create(@Request() req, @Param() params, @Body() createServiceDto: CreateServiceDto) {
    return new ServiceEntity(await this.servicesService.create(req.user.email, params.project, createServiceDto));
  }
  ...
  async findOne(@Request() req, @Param() params) {
    return new ServiceEntity(await this.servicesService.findOne(req.user.email, params.project, params.service));
  }
  ...
  @ApiParam({ name: 'service', required: true })
  @ApiParam({ name: 'project', required: true })
  async update(@Request() req, @Param() params, @Body() updateServiceDto: UpdateServiceDto) {
    return this.servicesService.update(req.user.email, params.project, params.service, updateServiceDto);
  }
  ...
  async remove(@Request() req, @Param() params) {
    return this.servicesService.remove(req.user.email, params.project, params.service);
  }
}
